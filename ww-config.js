export default {
    ...
    properties: {
        ...
        columnGroups: {
            ...
            options: {
                ...
                getItemLabel(item, index) {
                    return item?.label?.length ? item?.label : `Column Group ${index + 1}`;
                },
            },
            defaultValue: [],
            section: "settings",
                            ...
                            columnGroup: {
                                ...
                                options: {
                                    options: [
                                        ...
                                        ...(content.columnGroups || []).map(parent => ({
                                            value: parent.label,
                                            label: parent.label
                                        }))
                                    ],
        ...
        showTotalRow: {
            ...
            bindingValidation: {
                type: "boolean",
                tooltip: "Show a total row at the bottom of the grid",
            },
            /* wwEditor:end */
        },
        pagination: {
